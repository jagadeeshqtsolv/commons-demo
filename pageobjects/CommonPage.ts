...
export class CommonPage {
  ...
  atLeast1SavedNewsCardExists: { strategy: 'css' as const, value: '.LatestNewsWidget_smallCards__ZurN1 > div > div > img', actionKind: 'generic' as const },    articleContentIsDisplayed: { strategy: 'css' as const, value: 'body', actionKind: 'generic' as const },
  } as const;
