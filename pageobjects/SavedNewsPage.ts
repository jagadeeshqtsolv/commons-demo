...
export class SavedNewsPage {
  ...
  async expectUkgHomeQaVisible(timeoutMs = 15_000, soft = true): Promise<void> {
  ...
  async expectLatestNewsVisible(timeoutMs = 15_000, soft = true): Promise<void> {
