...
export class SavedNewsPage {
  ...
  async expectUkgHomeQaVisible(timeoutMs = 10_000, soft = true): Promise<void> {
  ...
  async expectLatestNewsVisible(timeoutMs = 10_000, soft = true): Promise<void> {
